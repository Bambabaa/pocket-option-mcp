...
**For CALL (K Flash Crash Bounce):**
- g1: bar0.ma1 < bar0.ma3 < bar0.ma2 (bearish MA stack — counter-trend bounce)
...
- g6: (bar0.ma3 - bar0.ma2) / bar0.ma2 * 10000 > -20 bps (not deeply bearish)

**For PUT (Late Overbought Reversal):**
...
- g5: bar0.ma1 > bar0.ma3 > bar0.ma2 (bullish MA stack — reversal from peak)
- g6: bar0.stochastic_k_v2 - bar0.stochastic_d_v2 < -3 (K below D, confirmed cross)
- g7: (bar0.ma3 - bar0.ma2) / bar0.ma2 * 10000 < 20 bps (not a strong uptrend)
...
|---|---|---|---|---|
| ≥ 6/7 (CALL) or 7/7 (PUT) | GOOD or CAUTION | ≥ 55% | ≥ 50% | **TRADE** |
| ≥ 5/7 | GOOD | ≥ 55% | ≥ 50% | **TRADE** |
| ≥ 5/7 | CAUTION | ≥ 50% | any | **WAIT** |
| < 5/7 | any | any | any | **SKIP** |
...
```json
{
  ...
  "skip_reason": null,
  "reasons": [
    "6/7 PUT gates pass — only MA trend gate marginal",
